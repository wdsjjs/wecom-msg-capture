...
const page = await browser.newPage({ viewport: { width: 640, height: 390 }, deviceScaleFactor: 1 });
...
await page.screenshot({ path: fileURLToPath(new URL('../public/device-sample.png', import.meta.url)) });
await browser.close();
